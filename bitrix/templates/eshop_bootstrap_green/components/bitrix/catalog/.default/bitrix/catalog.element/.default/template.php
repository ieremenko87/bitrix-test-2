...
<?
		...
		{
			if($arOneProp['CODE'] == 'PARTNER')
			{
				echo "<dt>Партнер</dt><dd>".$arOneProp['NAME']."</dd>";
				echo "<dt>Описание</dt><dd>".$arOneProp['DESCRIPTION']."</dd>";
				echo "<dt>Условия доставки</dt><dd>".$arOneProp['DELIVERY']."</dd>";
			}
			else
			{
?>
